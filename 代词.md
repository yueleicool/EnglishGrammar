...
③ a greate deal of:只修不可数名词。  
(12) none, no one, nobody  
① no one/ nobody: 指人，后不跟of短语，谓语用单数形式;  
② none: 指人也可指物,后可跟of短语，谓语可用单数也可以用复数。  
